...
public class Controller3 implements Initializable {
	...
	Image i3 = new Image(getClass().getResourceAsStream("2.jpeg"));
...
/*	String s1="Adada (2).mp3";
	...
	*/
    ...
    void play(ActionEvent event) {
		...
		if(currentSongFileName.equals("_Sooraj Dooba Hain")) {
    		img.setImage(i7);
    	}
		else if(currentSongFileName.equals("Tere Pyaar Mein")) {
    		img.setImage(i9);
    	}
		else  {
    		img.setImage(i3);
